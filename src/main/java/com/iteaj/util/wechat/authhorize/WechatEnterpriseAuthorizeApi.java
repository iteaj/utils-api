 ...
 * @since 1.7
 */
public class WechatEnterpriseAuthorizeApi
        extends OAuth2AuthorizeApi<WechatEnterpriseAuthorizeConfig, WechatEnterpriseAuthorizeParam>
        implements WechatApi<WechatEnterpriseAuthorizeConfig, WechatEnterpriseAuthorizeParam> {
