 ...
 * @since 1.7
 */
public class WxaWebAuthorize extends AbstractWechatOAuth2Api
        <WxcWebAuthorize, WxpWebAuthorize>{
     ...
     * 微信access_token入口阶段
     */
    protected class EntryPhase extends AbstractWechatPhase<WxpWebAuthorize> {
    ...
    protected class CodePhase extends AbstractWechatPhase<WxpWebAuthorize> {
    ...
    protected class TokenPhase extends AbstractWechatPhase<WxpWebAuthorize> {
    ...
    protected class UserPhase extends AbstractWechatPhase<WxpWebAuthorize> {
     ...
     */
    public static class AccessToken extends WechatApiReturn {
     ...
     * 微信返回的用户信息
     */
    public static class UserInfo extends WechatApiReturn {
        private String sex;
        private String city;
        private String openid;
