 ...
 * @since 1.7
 */
public class WxpTemplateMessage implements WechatApiParam<WxaTemplateMessage.MessageReturn> {
    ...
    public WxpTemplateMessage(String openId, String templateId) {
        this.openId = openId;
     ...
     * @return
     */
    public WxpTemplateMessage addItem(String key, String val) {
     ...
     * @return
     */
    public WxpTemplateMessage addItem(String key, String val, String color) {
    ...
    public WxpTemplateMessage setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public WxpTemplateMessage setTemplateId(String templateId) {
        this.templateId = templateId;
        return this;
    }
    ...
    public WxpTemplateMessage setMiniprogram(String miniprogram) {
    ...
    public WxpTemplateMessage setPagepath(String pagepath) {
    ...
    public WxpTemplateMessage setColor(String color) {
        this.color = color;
        return this;
    }
